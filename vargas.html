...
<head>
    ...
    <title>Vargas G</title>
    <link rel="stylesheet" href="assets/css/vargas.css">
</head>
<body>
    <header>
    ...
    <main>
        ...
        <div class="container">
            <div class="card">
                <div class="info">
                    <h5>My childhood</h5>
                    <p>I was alone at home for 20 minutes</p>
                    <img src="assets/images/img_juan/javgbaby.jpeg" alt="Childhood image" height="100">
                    <p>I used to practice taekwondo</p>
                    <img src="assets/images/img_juan/javgtkd.jpg" alt="Tournment image" height="200">
                </div>
            </div>
